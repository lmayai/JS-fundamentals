 ...
 * Se observa que al mirar el objeto this, éste hace referencia al WINDOW
 * Donde en window no hay un atributo altura.
 * Por tal es undefined y undefined no es mayor a 1.8
 * THIS es window, osea lo cambia. Apunta al this de afuera
 * This en el espacio global es window.
 * this === window -> es true
 * Por tal las arrow cambian quién es this
 */
...
// Por tal no se debe usar arrow functions para prototipos sin considerar el contexto.
